...
LOGO = 'None'
LIST_VEHICLE_OUT_PATH = [LOGO] * 4
LIST_CLASS_OUT = ['Unknown'] * 4
...
for inumber in [1,2,3,4,5,6]:
    sub_dir = os.path.join(VEHICLE_IMAGE, 'crop'+str(inumber))
...
@tracker.route('/vehicle_class', methods=['GET'])
def get_vehicle_class():
    try:
        result = {"list_class": LIST_CLASS_OUT}
